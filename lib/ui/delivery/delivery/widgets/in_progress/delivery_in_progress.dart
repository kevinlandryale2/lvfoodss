...
class DeliveryInProgress extends StatefulWidget {
  @override
  _DeliveryInProgressState createState() => _DeliveryInProgressState();
}
                    ...
                    children: [
                      ...
                      Expanded(
                          child:SingleChildScrollView(
                            child: DeliveryInProgressDisplay(deliveries: (test == true) ? visibleDeliveriesTwo! : visibleDeliveries!,),
                          ),
                      ),
                    ],
                  ),
