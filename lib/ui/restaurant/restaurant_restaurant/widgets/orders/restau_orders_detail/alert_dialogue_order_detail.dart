...
class AlertDialogueOrderReady extends StatefulWidget {
  const AlertDialogueOrderReady({Key? key}) : super(key: key);

  @override
  _AlertDialogueOrderReadyState createState() => _AlertDialogueOrderReadyState();
}
